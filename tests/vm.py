...
parser.add_argument('--bootstrap-command', help='test command that downloads and launches the installer')
...
wait('OWEN_READY')
send((args.bootstrap_command or 'owendots install /media/owendots') + '\r')
menu = wait('Target disk', timeout=600)
